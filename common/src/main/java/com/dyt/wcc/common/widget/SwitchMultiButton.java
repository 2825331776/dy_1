...
public class SwitchMultiButton extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mStrokeWidth = typedArray.getDimension(R.styleable.SwitchMultiButton_stroke_Width, STROKE_WIDTH);
        mTextSize = typedArray.getDimension(R.styleable.SwitchMultiButton_text_Size, TEXT_SIZE);
