...
public class MeasureEntity {
	...
	public String toString () {
		//", isCanMove=" + isCanMove +
		return "TempWidgetObj{" + "id=" + id + ", type=" + type + ", isSelect=" + isSelect + ", tempTextSize=" + tempTextSize + ", toolsPicRes size =" + toolsPicsBp.size() + ", toolsNumber=" + toolsNumber + ", pointTemp=" + pointTemp.toString() + ", otherTemp=" + otherTemp.toString() + '}';
	}
