 ...
 * <p>Create Date：2021/8/23  16:08     </p>
 * <p>Description：@自定义Spinner         </p>
...
public class MySpinner extends AppCompatTextView {
	...
	private void init (Context context, AttributeSet attrs) {
		...
		textColor = typedArray.getColor(R.styleable.MySpinner_textTint, getDefaultTextColor(context));
		...
		popupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
				...
				if (onSpinnerItemSelectedListener != null) {
					onSpinnerItemSelectedListener.onItemSelected(MySpinner.this, view, position, id);
				}
