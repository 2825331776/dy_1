 ...
 */
public class MeasureLineRectEntity {
	...
	public String toString () {
		return "OtherTempWidget{" + "startPointX=" + startPointX + ", startPointY=" + startPointY + ", endPointX=" + endPointX + ", endPointY=" + endPointY + ", minTemp='" + minTemp + '\'' + ", minTempX=" + minTempX + ", minTempY=" + minTempY + ", minTempDirection=" + minTempDirection + ", maxTemp='" + maxTemp + '\'' + ", maxTempX=" + maxTempX + ", maxTempY=" + maxTempY + ", maxTempDirection=" + maxTempDirection + '}';
	}

	public int getMinTempDirection () {
		return minTempDirection;
	}

	public void setMinTempDirection (int minTempDirection) {
		this.minTempDirection = minTempDirection;
	}

	public int getMaxTempDirection () {
		return maxTempDirection;
	}

	public void setMaxTempDirection (int maxTempDirection) {
		this.maxTempDirection = maxTempDirection;
	}
