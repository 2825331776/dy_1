package com.dyt.wcc.victor.utils;

public class LanguageUtils02 {
...
//	 * 默认支持的语言，英语、法语、阿拉伯语
//	 */
//	private static HashMap<String, Locale> supportLanguage = new HashMap<String, Locale>(2) {{
...
//		try {
//			// 多语言适配
//			Context context = LanguageUtils02.attachBaseContext(newBase);
