...
public class NotificationHelper {
	...
	private void createChannel (String channelId, String channelName, int importance, boolean isShowBadge) {
		...
		NotificationManager notificationManager = (NotificationManager) DYTApplication.getInstance().getSystemService(NOTIFICATION_SERVICE);
	...
	public NotificationCompat.Builder create (String channelId) {
		...
		return new NotificationCompat.Builder(context, channelId).setContentTitle(context.getString(R.string.app_name)).setWhen(System.currentTimeMillis()).setSmallIcon(R.mipmap.ic_launcher_victor).setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher_victor));
	}
