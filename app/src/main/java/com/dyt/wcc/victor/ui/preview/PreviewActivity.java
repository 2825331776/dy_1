...
import com.dyt.wcc.victor.BuildConfig;
import com.dyt.wcc.victor.R;
import com.dyt.wcc.victor.constans.DYConstants;
import com.dyt.wcc.victor.constans.DYTApplication;
import com.dyt.wcc.victor.constans.DYTRobotSingle;
import com.dyt.wcc.victor.databinding.ActivityPreviewBinding;
import com.dyt.wcc.victor.databinding.PopCompanyInfoBinding;
import com.dyt.wcc.victor.databinding.PopHighlowcenterTraceBinding;
import com.dyt.wcc.victor.databinding.PopPaletteChoiceBinding;
import com.dyt.wcc.victor.databinding.PopSettingBinding;
import com.dyt.wcc.victor.databinding.PopTempModeChoiceBinding;
import com.dyt.wcc.victor.ui.gallery.GlideEngine;
import com.dyt.wcc.victor.ui.pdfPreview.PdfActivity;
import com.dyt.wcc.victor.utils.AssetCopyer;
import com.dyt.wcc.victor.utils.ByteUtilsCC;
import com.dyt.wcc.victor.utils.CreateBitmap;
import com.dyt.wcc.victor.utils.LanguageUtils;
import com.dyt.wcc.victor.widget.MyNumberPicker;
		...
		mDataBinding.ivPreviewLeftGallery.setOnClickListener(v -> {
			...
			if (mDataBinding.btPreviewLeftRecord.isSelected()) {
				...
				EasyPhotos.createAlbum(PreviewActivity.this, false, false,
						GlideEngine.getInstance()).setFileProviderAuthority(fileProviderAuthority)
						.setCount(1000).setVideo(true).setGif(false).start(101);
			}
		});
...
//				}
			...
			popCompanyInfoBinding.tvAboutMainUserManualInfo.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG); //下划线
			popCompanyInfoBinding.tvAboutMainUserManualInfo.setOnClickListener(v2 ->{
	...
	private void showPopWindows (View view) {
		...
		companyPopWindows.setHeight(DensityUtil.dp2px(mContext.get(), 145));
