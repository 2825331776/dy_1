 ...
 */
public class TeslongLanguageFactory extends LanguageFactory {
	public TeslongLanguageFactory (Context mContext) {
		super(mContext);
	}
	...
	public CharSequence getLanguageByIndex (@NonNull int index) {
		if (index < language_teslong_array.length) {
			return language_teslong_array[index];
		} else {
			return language_teslong_array[0];
		}
	}
	...
	public AlertDialog createAlertDialog () {
		...
		return builder.setSingleChoiceItems(LanguageFactory.language_teslong_array,
