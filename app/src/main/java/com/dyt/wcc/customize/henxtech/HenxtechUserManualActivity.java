...
public class HenxtechUserManualActivity extends BaseActivity<ActivityPdfBinding> {
...
//	final String[] sampleAssets = {"HenxtechReadMeCN.pdf", "HenxtechReadMeEN.pdf"};
	File pdfFolder;
