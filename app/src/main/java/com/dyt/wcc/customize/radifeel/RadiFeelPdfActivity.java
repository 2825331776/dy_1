...
public class RadiFeelPdfActivity extends BaseActivity<ActivityPdfBinding> {
...
//	final String[] sampleAssets = {"RadiFeelReadMeCN.pdf", "RadiFeelReadMeEN.pdf"};
	File pdfFolder;
