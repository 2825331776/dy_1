...
public class HenxtechLanguageFactory extends LanguageFactory {
	...
	public CharSequence getLanguageByIndex (@NonNull int index) {
		if (index < language_henxtech_array.length) {
			return language_henxtech_array[index];
		} else {
			return language_henxtech_array[0];
		}
	}
	...
	public AlertDialog createAlertDialog () {
		...
		return builder.setSingleChoiceItems(LanguageFactory.language_henxtech_array,
	...
	public String[] getLanguageArray () {
		return language_henxtech_array;
	}
}
