...
public class VotinLanguageFactory extends LanguageFactory {
	...
	public CharSequence getLanguageByIndex (@NonNull int index) {
		if (index < language_votin_array.length) {
			return language_votin_array[index];
		} else {
			return language_votin_array[0];
		}
	}
	...
	public AlertDialog createAlertDialog () {
		...
		return builder.setSingleChoiceItems(LanguageFactory.language_votin_array,
