...
import com.dyt.wcc.databinding.PopCompanyHenxtechBinding;
 ...
 */
public class HenxtechCompanyView extends CustomizeCompany {
	...
	public View getCompanyView (Context context) {
		...
		return LayoutInflater.from(context).inflate(R.layout.pop_company_henxtech, null);
	}

	@Override
	public void initListener (View view) {
		PopCompanyHenxtechBinding henxtechBinding = DataBindingUtil.bind(view);
		//根据是中文还是因为 区分是主营/邮箱反馈
		henxtechBinding.tvAboutContactUsEmail.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG);
		henxtechBinding.tvAboutContactUsEmail.setOnClickListener(v19 -> {
