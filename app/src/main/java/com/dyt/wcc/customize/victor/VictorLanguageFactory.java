 ...
 */
public class VictorLanguageFactory extends LanguageFactory {
	public VictorLanguageFactory (Context mContext) {
		super(mContext);
	}
	...
	public CharSequence getLanguageByIndex (@NonNull int index) {
		if (index < language_victor_array.length) {
			return language_victor_array[index];
		} else {
			return language_victor_array[0];
		}
	}
	...
	public AlertDialog createAlertDialog () {
		...
		return builder.setSingleChoiceItems(LanguageFactory.language_victor_array,
