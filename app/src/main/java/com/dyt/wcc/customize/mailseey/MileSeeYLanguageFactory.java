...
public class MileSeeYLanguageFactory extends LanguageFactory {
	...
	public CharSequence getLanguageByIndex (@NonNull int index) {
		if (index < language_mileseey_array.length) {
			return language_mileseey_array[index];
		} else {
			return language_mileseey_array[0];
		}
	}
	...
	public AlertDialog createAlertDialog () {
		...
		return builder.setSingleChoiceItems(LanguageFactory.language_mileseey_array,
	...
	public String[] getLanguageArray () {
		return language_mileseey_array;
	}
}
