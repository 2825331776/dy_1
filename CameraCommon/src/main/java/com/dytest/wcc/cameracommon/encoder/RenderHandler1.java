package com.dytest.wcc.cameracommon.encoder;
...
import com.dytest.wcc.cameracommon.widget.GLDrawer2D1;
...
public final class RenderHandler1 extends Handler {
	...
	//********************************************************************************
	//********************************************************************************
	private RenderHandler1 (final RenderThread thread) {
	...
	private static final class RenderThread extends Thread {
		...
		public final void handleSetEglContext (final EGLBase.IContext shardContext, final Object surface, final boolean isRecordable) {
			...
			release();
			synchronized (mSync) {
				mSurface = surface instanceof Surface ? (Surface) surface : (surface instanceof SurfaceTexture ? new Surface((SurfaceTexture) surface) : null);
			}
