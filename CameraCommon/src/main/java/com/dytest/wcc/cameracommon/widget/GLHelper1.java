 ...
 * OpenGL 的辅助类 | ES2 / 3
 */
public final class GLHelper1 {
	public static final  int[]  TEX_NUMBERS = {GLES20.GL_TEXTURE0, GLES20.GL_TEXTURE1, GLES20.GL_TEXTURE2, GLES20.GL_TEXTURE3, GLES20.GL_TEXTURE4, GLES20.GL_TEXTURE5, GLES20.GL_TEXTURE6, GLES20.GL_TEXTURE7, GLES20.GL_TEXTURE8, GLES20.GL_TEXTURE9, GLES20.GL_TEXTURE10, GLES20.GL_TEXTURE11, GLES20.GL_TEXTURE12, GLES20.GL_TEXTURE13, GLES20.GL_TEXTURE14, GLES20.GL_TEXTURE15, GLES20.GL_TEXTURE16, GLES20.GL_TEXTURE17, GLES20.GL_TEXTURE18, GLES20.GL_TEXTURE19, GLES20.GL_TEXTURE20, GLES20.GL_TEXTURE21, GLES20.GL_TEXTURE22, GLES20.GL_TEXTURE23, GLES20.GL_TEXTURE24, GLES20.GL_TEXTURE25, GLES20.GL_TEXTURE26, GLES20.GL_TEXTURE27, GLES20.GL_TEXTURE28, GLES20.GL_TEXTURE29, GLES20.GL_TEXTURE30, GLES20.GL_TEXTURE31,};
	//	private static final boolean DEBUG = false;	// FIXME 実働時はfalseにすること
	private static final String TAG         = "GLHelper1";

	/**
	 * 检查 OpenGL | ES 错误并输出到 logCat
	 *
	 * @param op
	 */
	 ...
	 * @return
	 */
	public static int[] initTexes (final int n, final int texTarget, final int filter_param) {

		return initTexes(new int[n], texTarget, filter_param, filter_param, GLES20.GL_CLAMP_TO_EDGE);
	}

	public static int[] initTexes (int[] para) {

		int[] texIds = new int[para[0]];
		...
		final int n = para[0] > textureUnits[0] ? textureUnits[0] : para[0];
		for (int i = 0; i < n; i++) {
			texIds[i] = GLHelper1.initTex(para[4 * i + 1], TEX_NUMBERS[i], para[4 * i + 2], para[4 * i + 3], para[4 * i + 4]);
		}
		return texIds;
	}
	 ...
	 * @return
	 */
	public static int[] initTexes (@NonNull final int[] texIds, final int texTarget, final int filter_param) {

		return initTexes(texIds, texTarget, filter_param, filter_param, GLES20.GL_CLAMP_TO_EDGE);
	}
	 ...
	 * @return
	 */
	public static int[] initTexes (@NonNull final int n, final int texTarget, final int min_filter, final int mag_filter, final int wrap) {
	 ...
	 * @return
	 */
	public static int[] initTexes (@NonNull final int[] texIds, final int texTarget, final int min_filter, final int mag_filter, final int wrap) {

		int[] textureUnits = new int[1];
		GLES20.glGetIntegerv(GLES20.GL_MAX_TEXTURE_IMAGE_UNITS, textureUnits, 0);
		Log.v(TAG, "GL_MAX_TEXTURE_IMAGE_UNITS=" + textureUnits[0]);
		final int n = texIds.length > textureUnits[0] ? textureUnits[0] : texIds.length;
		for (int i = 0; i < n; i++) {
			texIds[i] = GLHelper1.initTex(texTarget, TEX_NUMBERS[i], min_filter, mag_filter, wrap);
		}
		return texIds;
	}
	 ...
	 * @return
	 */
	public static int[] initTexes (final int n, final int texTarget, final int texUnit, final int min_filter, final int mag_filter, final int wrap) {
	 ...
	 * @return
	 */
	public static int[] initTexes (@NonNull final int[] texIds, final int texTarget, final int texUnit, final int filter_param) {

		return initTexes(texIds, texTarget, texUnit, filter_param, filter_param, GLES20.GL_CLAMP_TO_EDGE);
	}
	 ...
	 * @return
	 */
	public static int[] initTexes (@NonNull final int[] texIds, final int texTarget, final int texUnit, final int min_filter, final int mag_filter, final int wrap) {

		int[] textureUnits = new int[1];
		GLES20.glGetIntegerv(GLES20.GL_MAX_TEXTURE_IMAGE_UNITS, textureUnits, 0);
		final int n = texIds.length > textureUnits[0] ? textureUnits[0] : texIds.length;
		for (int i = 0; i < n; i++) {
			texIds[i] = GLHelper1.initTex(texTarget, texUnit, min_filter, mag_filter, wrap);
		}
		return texIds;
	}
	 ...
	 * @return
	 */
	public static int loadShader (@NonNull final Context context, final String vss_asset, final String fss_asset) {
